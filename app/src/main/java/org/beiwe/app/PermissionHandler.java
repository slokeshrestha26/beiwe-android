...
public class PermissionHandler {
	...
	public static Map <String, Integer> permissionMessages = new HashMap <> ();
	static {
		permissionMessages.put(Manifest.permission.ACCESS_FINE_LOCATION, R.string.permission_access_fine_location);
