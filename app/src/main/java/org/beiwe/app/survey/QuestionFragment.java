...
public class QuestionFragment extends Fragment {
	...
	public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		Button backButton = (Button) fragmentQuestionLayout.findViewById(R.id.backButton);
		...
		backButton.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick (View view) {
				getActivity().onBackPressed(); // very easy
			}
		});
	...
	@Override
	/** This function will get called on NEW versions of Android (6+). ... and now it's been deprecated tooooo! */
	...
	private QuestionData getAnswer (View questionLayout, QuestionType.Type questionType) {
		...
		if (answerIntegerValue != null) {
			questionData.setAnswerInteger(answerIntegerValue);
		}
		return questionData;
	}
